...
export default function EditProduct({ product, onCancel, onProductUpdated }) {
    const {
        register,
        handleSubmit,
        formState: { errors },
    ...
    const onSubmit = async (data) => {
        try {
            const response = await fetch(`https://crud.teamrabbil.com/api/v1/UpdateProduct/${product._id}`, {
                method: "POST",
                headers: {
